<?php
function Pedidos($precio,$nombre,$telefono,$base,$carbohidratos,$proteina,$complementos,$adicional,$vinagreta,$tiempo,$horario,$direccion,$empresa,$oficina,$tipo,$monto) {
  $HTML = '
  <html>
  ...
  <div style="">
    ...
    <strong> <h4> Datos </h4></strong>
      ...
      <strong> <h4> Pedido </h4></strong>
      Base          : '.$base.' <br>
      Carbohidratos : '.$carbohidratos.'<br>
      Proteina      :  '.$proteina.'                 <br>
      Complementos  : '.$complementos.'<br>
      Adicional     :    '.$adicional .'     <br>
      Vinagreta     : '.$vinagreta.'<br>
